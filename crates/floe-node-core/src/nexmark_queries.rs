...
pub struct NexmarkQuerySpec {
    ...
    pub blocker_crates: &'static [&'static str],
}
...
pub const CANONICAL_NEXMARK_QUERIES: &[NexmarkQuerySpec] = &[
    ...
    NexmarkQuerySpec {
        ...
        features: &["projection", "arithmetic"],
        blocker_crates: &[],
    },
    NexmarkQuerySpec {
        id: "q2",
        sql: "SELECT auction, price FROM bid WHERE auction % 123 = 0",
        features: &["filter", "arithmetic"],
        blocker_crates: &[],
    },
    NexmarkQuerySpec {
        id: "q3",
    ...
    NexmarkQuerySpec {
        ...
        features: &["join", "group_aggregate", "nested_subquery"],
        blocker_crates: &[],
    },
    NexmarkQuerySpec {
        id: "q5",
        sql: "SELECT auction, COUNT(*) AS num FROM bid GROUP BY auction, HOP(\"dateTime\", 2000, 10000)",
        features: &["hop_window", "window_functions", "join", "group_aggregate"],
        blocker_crates: &["floe-node-core", "dbsp-planner", "floe-executor"],
    },
    NexmarkQuerySpec {
        id: "q6",
        ...
        features: &["row_number", "join", "subquery", "group_aggregate"],
        blocker_crates: &["dbsp-planner", "floe-executor"],
    },
    NexmarkQuerySpec {
        id: "q7",
        sql: "SELECT MAX(price) AS maxprice FROM bid GROUP BY TUMBLE(\"dateTime\", 10000)",
        features: &["tumble_window", "window_join"],
        blocker_crates: &["floe-node-core", "dbsp-planner", "floe-executor"],
    },
    NexmarkQuerySpec {
        id: "q8",
        sql: "SELECT id, name, COUNT(*) AS person_count FROM person GROUP BY id, name, TUMBLE(\"dateTime\", 10000)",
        features: &["tumble_window", "window_join", "nested_subquery"],
        blocker_crates: &["floe-node-core", "dbsp-planner", "floe-executor"],
    },
    NexmarkQuerySpec {
        id: "q9",
        ...
        features: &["row_number", "topn", "join", "nested_subquery"],
        blocker_crates: &["dbsp-planner", "floe-executor"],
    },
    NexmarkQuerySpec {
        id: "q12",
        sql: "SELECT bidder, COUNT(*) AS bid_count FROM bid GROUP BY bidder, TUMBLE(\"dateTime\", 10000)",
        features: &["processing_time", "tumble_window", "group_aggregate"],
        blocker_crates: &["floe-node-core", "dbsp-planner"],
    },
    NexmarkQuerySpec {
        id: "q13",
        ...
        features: &["processing_time", "join", "mod"],
        blocker_crates: &[],
    },
    NexmarkQuerySpec {
        id: "q14",
    ...
    NexmarkQuerySpec {
        ...
        features: &["filtered_aggregate", "distinct_aggregate", "date_format"],
        blocker_crates: &["dbsp-planner", "floe-executor"],
    },
    NexmarkQuerySpec {
        id: "q16",
    ...
    NexmarkQuerySpec {
        ...
        features: &["filtered_aggregate", "date_format", "group_aggregate"],
        blocker_crates: &["dbsp-planner", "floe-executor"],
    },
    NexmarkQuerySpec {
        id: "q18",
    ...
    NexmarkQuerySpec {
        ...
        features: &["join", "projection", "filter"],
        blocker_crates: &[],
    },
    NexmarkQuerySpec {
        id: "q21",
    ...
    NexmarkQuerySpec {
        ...
        features: &["split_index", "projection"],
        blocker_crates: &["floe-executor"],
    },
];
