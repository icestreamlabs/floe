...
mod tests {
    ...
    use crate::pgoutput_test_messages::{
        ...
        put_unchanged_toast_value, relation_message_with_identity_and_column_specs,
        truncate_message, tuple, tuple_with_unchanged_toast,
    };
    use floe_core::RowValue;
    ...
    fn pgoutput_type_compatibility_matrix_is_explicit() {
        ...
        assert_eq!(
            tuple_value_to_row_value(&text_column, &PgOutputTupleValue::Null)
                .expect("nullable text"),
            None
        );
